...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="#">Home</a> / Browse</span>
    <h2>Browse</h2>
</div>
</div>
<!-- banner -->
...
<h2><?php if( $singleData->approved == 'true' ) {
echo $singleData->name ?></h2>
<div class="row">
  <div class="col-lg-8">
...
<p class="price"> <?php echo number_format( $singleData->monthly_charges ) ?> INR.</p>
  ...
  <p class="area"><span class="glyphicon glyphicon-th-list"></span>Type :  <?php echo $singleData->access ?></p>
  <p class="area"><span class="glyphicon glyphicon-th-list"></span>Rooms :  <?php echo $singleData->utility ?></p>
</div>
...
<?php } else die('<u>You are not allowed to view this page.</u>'); include'footer.php';?>